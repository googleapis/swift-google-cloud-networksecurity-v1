  ...
  final class FirewallActivationTransport: FirewallActivationStub {
    ...
    public func listFirewallEndpoints(
      ...
      let path = try { () throws -> Swift.String in
        ...
        return "/v1/\(pathVariable0)/firewallEndpoints"
      }()
      var query = [
    ...
    public func updateFirewallEndpoint(
      ...
      let path = try { () throws -> Swift.String in
        guard let pathVariable0 = request.firewallEndpoint.map({ $0.name }), !pathVariable0.isEmpty
        else {
          throw GoogleCloudGax.RequestError.binding(
            "'request.firewall_endpoint.name' is not set or is empty")
        }
        return "/v1/\(pathVariable0)"
      }()
      var query = [
    ...
    public func listFirewallEndpointAssociations(
      ...
      let path = try { () throws -> Swift.String in
        ...
        return "/v1/\(pathVariable0)/firewallEndpointAssociations"
      }()
      var query = [
        URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
      ]
    ...
    public func updateFirewallEndpointAssociation(
      ...
      let path = try { () throws -> Swift.String in
        guard let pathVariable0 = request.firewallEndpointAssociation.map({ $0.name }),
          !pathVariable0.isEmpty
        else {
          throw GoogleCloudGax.RequestError.binding(
            "'request.firewall_endpoint_association.name' is not set or is empty")
        }
        return "/v1/\(pathVariable0)"
      }()
      var query = [
