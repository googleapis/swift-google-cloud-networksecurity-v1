  ...
  public func createInterceptEndpointGroup(
    ...
    let extractStatus = {
      ...
      case .response(let anyValue):
        ...
        let response = try InterceptEndpointGroup(fromAny: anyValueUnwrapped)
  ...
  public func createInterceptEndpointGroupAssociation(
    ...
    let extractStatus = {
      ...
      case .response(let anyValue):
        ...
        let response = try InterceptEndpointGroupAssociation(fromAny: anyValueUnwrapped)
        return .init(done: true, result: .success(response))
      case .error(let status):
        guard let statusUnwrapped = status else {
          return .init(
  ...
  public func createInterceptDeploymentGroup(
    ...
    let extractStatus = {
      ...
      case .response(let anyValue):
        ...
        let response = try InterceptDeploymentGroup(fromAny: anyValueUnwrapped)
        return .init(done: true, result: .success(response))
      case .error(let status):
        guard let statusUnwrapped = status else {
          return .init(
  ...
  public func createInterceptDeployment(
    ...
    let extractStatus = {
      ...
      case .response(let anyValue):
        ...
        let response = try InterceptDeployment(fromAny: anyValueUnwrapped)
        return .init(done: true, result: .success(response))
      case .error(let status):
        guard let statusUnwrapped = status else {
          return .init(
