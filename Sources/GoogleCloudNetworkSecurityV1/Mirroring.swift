  ...
  public func createMirroringEndpointGroup(
    ...
    let extractStatus = {
      ...
      case .response(let anyValue):
        ...
        let response = try MirroringEndpointGroup(fromAny: anyValueUnwrapped)
  ...
  public func createMirroringEndpointGroupAssociation(
    ...
    let extractStatus = {
      ...
      case .response(let anyValue):
        ...
        let response = try MirroringEndpointGroupAssociation(fromAny: anyValueUnwrapped)
        return .init(done: true, result: .success(response))
      case .error(let status):
        guard let statusUnwrapped = status else {
          return .init(
  ...
  public func createMirroringDeploymentGroup(
    ...
    let extractStatus = {
      ...
      case .response(let anyValue):
        ...
        let response = try MirroringDeploymentGroup(fromAny: anyValueUnwrapped)
        return .init(done: true, result: .success(response))
      case .error(let status):
        guard let statusUnwrapped = status else {
          return .init(
  ...
  public func createMirroringDeployment(
    ...
    let extractStatus = {
      ...
      case .response(let anyValue):
        ...
        let response = try MirroringDeployment(fromAny: anyValueUnwrapped)
        return .init(done: true, result: .success(response))
      case .error(let status):
        guard let statusUnwrapped = status else {
          return .init(
