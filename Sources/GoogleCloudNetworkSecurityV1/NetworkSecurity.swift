  ...
  public func createAuthorizationPolicy(
    ...
    let extractStatus = {
      ...
      case .response(let anyValue):
        ...
        let response = try AuthorizationPolicy(fromAny: anyValueUnwrapped)
  ...
  public func createBackendAuthenticationConfig(
    ...
    let extractStatus = {
      ...
      case .response(let anyValue):
        ...
        let response = try BackendAuthenticationConfig(fromAny: anyValueUnwrapped)
        return .init(done: true, result: .success(response))
      case .error(let status):
        guard let statusUnwrapped = status else {
          return .init(
  ...
  public func createServerTlsPolicy(
    ...
    let extractStatus = {
      ...
      case .response(let anyValue):
        ...
        let response = try ServerTlsPolicy(fromAny: anyValueUnwrapped)
        return .init(done: true, result: .success(response))
      case .error(let status):
        guard let statusUnwrapped = status else {
          return .init(
  ...
  public func createClientTlsPolicy(
    ...
    let extractStatus = {
      ...
      case .response(let anyValue):
        ...
        let response = try ClientTlsPolicy(fromAny: anyValueUnwrapped)
        return .init(done: true, result: .success(response))
      case .error(let status):
        guard let statusUnwrapped = status else {
          return .init(
  ...
  public func createGatewaySecurityPolicy(
    ...
    let extractStatus = {
      ...
      case .response(let anyValue):
        ...
        let response = try GatewaySecurityPolicy(fromAny: anyValueUnwrapped)
        return .init(done: true, result: .success(response))
      case .error(let status):
        guard let statusUnwrapped = status else {
          return .init(
  ...
  public func createGatewaySecurityPolicyRule(
    ...
    let extractStatus = {
      ...
      case .response(let anyValue):
        ...
        let response = try GatewaySecurityPolicyRule(fromAny: anyValueUnwrapped)
        return .init(done: true, result: .success(response))
      case .error(let status):
        guard let statusUnwrapped = status else {
          return .init(
  ...
  public func createUrlList(
    ...
    let extractStatus = {
      ...
      case .response(let anyValue):
        ...
        let response = try UrlList(fromAny: anyValueUnwrapped)
        return .init(done: true, result: .success(response))
      case .error(let status):
        guard let statusUnwrapped = status else {
          return .init(
  ...
  public func createTlsInspectionPolicy(
    ...
    let extractStatus = {
      ...
      case .response(let anyValue):
        ...
        let response = try TlsInspectionPolicy(fromAny: anyValueUnwrapped)
        return .init(done: true, result: .success(response))
      case .error(let status):
        guard let statusUnwrapped = status else {
          return .init(
  ...
  public func createAuthzPolicy(
    ...
    let extractStatus = {
      ...
      case .response(let anyValue):
        ...
        let response = try AuthzPolicy(fromAny: anyValueUnwrapped)
        return .init(done: true, result: .success(response))
      case .error(let status):
        guard let statusUnwrapped = status else {
          return .init(
