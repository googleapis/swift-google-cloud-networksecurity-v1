...
extension Clients {
  final class DnsThreatDetectorServiceRetry: DnsThreatDetectorServiceStub {
    let inner: any DnsThreatDetectorServiceStub
    let options: GoogleCloudGax.ClientOptions

    public init(_ inner: any DnsThreatDetectorServiceStub, options: GoogleCloudGax.ClientOptions) {
      self.inner = inner
